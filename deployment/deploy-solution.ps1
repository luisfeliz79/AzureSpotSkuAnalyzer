...
Write-host "Configurating Private endpoints..."
...
Write-host "Creating Application Insights instance..."
...
Write-host "Configuring Azure Functions Always on..."
az functionapp config set --always-on true --name $functionName --resource-group $resourceGroupName

Write-host "Configuring Azure Functions Host Storage with Managed Identity..."
...
Write-host "Azure Functions Clean up unneeded settings..."
...
Write-host "Azure Monitor Data Collection Rule and Data Collection Endpoint"
...
Write-host "RBAC: Assigning Monitoring Metrics Publisher to the DCR..."
...
Write-host "Configuring Azure Monitor details as Environment Variables..."
...
Write-host "Configuring SKU details as Environment Variables..."
...
Write-host "Deploying Azure Function app code..."
# Deploy the function code
# Create a zip file of the function app
Compress-Archive -Path ./PlacementStoreDashboard/* -DestinationPath ./PlacementStoreDashboard.zip -Force 

az functionapp deployment source config-zip `
    --name $functionName `
    --resource-group $resourceGroupName `
    --src .\PlacementStoreDashboard.zip
